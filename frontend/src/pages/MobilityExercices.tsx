    ...
    const fetchExercises = async () => {
      ...
      try {
        ...
        if (selectedSubcategory) {
          ...
          response = await exerciseAPI.getExercisesByCategory("Mobilité");
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">🤸 Mobilité</h1>
        <p className="text-gray-600 mb-8">
          Améliorez votre flexibilité et votre mobilité articulaire
        </p>
...
export default MobilityExercices;
