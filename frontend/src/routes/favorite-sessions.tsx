            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 z-10 p-2 rounded-full bg-red-500/30 text-red-400 hover:bg-red-500/40 transition-all duration-300"
